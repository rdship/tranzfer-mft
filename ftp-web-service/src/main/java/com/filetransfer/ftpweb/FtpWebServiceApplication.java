...
@ComponentScan(
    basePackages = {"com.filetransfer.ftpweb", "com.filetransfer.shared"},
...
public class FtpWebServiceApplication {
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(FtpWebServiceApplication.class); app.setBanner(new PlatformBanner()); app.run(args);
    }
}
