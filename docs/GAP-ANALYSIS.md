...
| T4 | **Frontend tests missing** — No unit tests, component tests, or E2E tests for ui-service, ftp-web-ui, or partner-portal. | Medium — 34 admin pages with zero test coverage. | Add Vitest for unit tests and Playwright for E2E tests. |
