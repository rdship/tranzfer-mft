...
**Date:** 2026-04-15 19:22:24
**Results:** PASS=31 | FAIL=4 | WARN=5 | SKIP=7
...
| FAIL | Activity Monitor filter status=COMPLETED returned 400 |
...
| PASS | Artifacts captured to /tmp/mft-sanity-20260415-192214 |

## Artifacts
- Thread dumps: `/tmp/mft-sanity-20260415-192214/thread-dump-*.txt`
- DB state: `/tmp/mft-sanity-20260415-192214/db-state.txt`
- Container status: `/tmp/mft-sanity-20260415-192214/container-status.txt`
- Memory stats: `/tmp/mft-sanity-20260415-192214/memory-stats.txt`
