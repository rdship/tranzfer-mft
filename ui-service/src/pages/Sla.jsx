  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        open={!!confirmDelete}
        variant="danger"
        title="Delete SLA agreement?"
        message={confirmDelete ? `Are you sure you want to delete SLA agreement "${confirmDelete.name || confirmDelete.partnerName}"? This action cannot be undone.` : ''}
        confirmLabel="Delete"
        cancelLabel="Cancel"
