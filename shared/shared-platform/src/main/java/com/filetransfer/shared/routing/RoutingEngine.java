...
public class RoutingEngine {
    ...
    private void addInternalAuth(HttpHeaders headers, String targetService) {
        ...
        if (!spiffeWorkloadClient.isAvailable()) {
            log.warn("[RoutingEngine] SPIFFE unavailable — outbound call to '{}' will go header-less and likely 403",
                    targetService);
            return;
        }
        ...
        if (token != null) {
            ...
            log.warn("[RoutingEngine] SPIFFE JWT-SVID null for target '{}' — header-less call will likely 403",
                    targetService);
        }
    }
