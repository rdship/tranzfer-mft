...
export default function Transfers({ username }) {
  ...
  return (
    <div className="space-y-4">
      <div><h1 className="text-2xl font-bold text-gray-900">Transfer History</h1>
        <p className="text-gray-500 text-sm">View all file transfers associated with your account</p></div>
      <div className="bg-white rounded-xl border">
        <table className="w-full">
          ...
          <tbody>
            {transfers.length === 0 ? (
              <tr><td colSpan={6} className="text-center py-8 text-gray-500 text-sm">No transfers found. Files will appear here once they are sent or received.</td></tr>
            ) : transfers.map(t => (
